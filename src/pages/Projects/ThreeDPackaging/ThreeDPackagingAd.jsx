          ...
          <div id="overview">
            <DetailBox title="OVERVIEW" colorClass="pink">
              <p>
                ...
                assignment using Adobe Dimension. The goal was to explore how my
                personal creative work could be transformed into promotional
                materials using Adobe Dimension and After Effects.
                <br />
          ...
          <div id="inspiration">
            <DetailBox title="INSPIRATION" colorClass="green">
              <p>
                ...
                focus on color, shape, and personality—which matches my playful
                style perfectly.
                <br />
                <br />
                Since I also love food, I thought it would be fun to turn my
                favorite foods into pixel designs. The idea of combining food
                and fashion felt natural to me, and I wanted to bring a playful
                and appetizing vibe to my brand. The inspiration behind this
                project is really just a mix of my personal tastes: pixel art,
                cute foods, and bold, fun visuals.
              </p>
            </DetailBox>
          </div>
              ...
              <div className="box-split">
                <div className="box-text">
                  <p>
                    ...
                    working on the 3D packaging assignment, I thought it would
                    be fun to transform my 2D design into a playful promotional
                    ...
                    naturally as a fun tagline that connects the themes of
                    fashion and food.
                    <br />
                    <br />I began by thinking about what kind of items would
                    best reflect my brand identity. Since I’m Japanese and love
                    pixel art, I decided to combine both. I made a small list of
                    cute foods and chose ramen, sushi, and onigiri because
                    they’re fun to draw and popular with many people. I also
                    included California rolls and other recognizable sushi types
                    so the design would feel familiar to people outside of Japan
                    as well.
                  </p>
                </div>
