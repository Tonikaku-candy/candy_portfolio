      ...
      <div className="project-detail-page">
        ...
        <div className="detail-box-wrapper">
          ...
          <DetailBox title="Overview" colorClass="pink">
            <p>
              A fan-made music video created in Adobe After Effects, focusing on
              beat-synced motion, bold type, and colorful visuals. Clothes are
              mostly handmade by Candy, blending fashion craft with motion
              ...
              tones, and textures so each scene feels unexpected and fresh. The
              intent is to keep viewers constantly surprised, visually
              ...
              introduce in the following section. This helped translate initial
              sketches into live-action shots, later composited digitally.
              <br />
              <br />
              Overall, the mood is colorful, surreal, and intentionally
              chaotic—combining humor, absurdity, visual metaphors, and cultural
              references into a vibrant journey.
            </p>
          </DetailBox>
          ...
          <DetailBox title="INSPIRATION" colorClass="green">
            <p>
              This project was inspired by Harajuku street fashion, playful pop
              visuals, and the energetic rhythm of Kaela Kimura’s song “Magic
              Music.” Because the song itself is bright and fun — and the
              official MV is already chaotic — I wanted to push this energy even
              further by turning my project into something like “colorful visual
              overload.”
            </p>
            <br />

            <p>
              Instead of keeping it safe with a traditional lyric video, I took
              the opportunity of having my teacher’s support to experiment
              wildly. It was my first time using green screen compositing, and I
              decided to appear in the video myself — though often hiding behind
              sunglasses or digital effects to disguise my face. Ironically,
              this shyness turned into a strange and funny part of the video’s
              personality.
            </p>
            <br />

            <p>
              Overall, the video is colorful, surreal, and intentionally chaotic
              — combining humor, absurdity, visual metaphors, and cultural
              references into what I call a “crazy MV packed with everything I
              wanted to try.”
            </p>
          ...
          <DetailBox title="Production" colorClass="purple">
            ...
            >
              ...
              <div className="gif-wrapper small">
                <img src={production1} alt="production scene" loading="lazy" />
              </div>

              <p>
                From 0:51 to 1:09, I created a sequence based on the lyric “sexy
                girl.” A woman at the beach turns around to reveal a clown face,
                blows a kiss, and a heart flies out. In the next karate scene,
                the heart gets punched to the right in rhythm with the beat.
                Finally, during the stage performance, the heart flies in from
                the left, hits the singer’s head, and shatters. These three
                moments are linked together through the recurring heart motif.
              </p>
              <div className="gif-wrapper small">
                <img src={production2} alt="production scene" loading="lazy" />
              </div>

              <p>
                The karate and stage scenes were especially meaningful because
                they reinterpret animations I had previously created in my{' '}
                <Link to="/projects/rhythm-game" className="rhythm-gamer-link">
                  “Rhythm Game Animation project",
                </Link>
                now brought into live-action form. I had imagined doing them
                myself back when I first made the animation, so this MV gave me
                the chance to realize that idea in practice.
              </p>
              <div className="gif-wrapper small">
                <img src={production3} alt="production scene" loading="lazy" />
              </div>
              ...
              <div className="gif-wrapper small">
                <img src={production4} alt="production scene" loading="lazy" />
              </div>

              <p>
                From 1:14 to 1:22, I staged a fashion show scene to showcase the
                clothes I had personally designed. Since the song is titled
                “Magic Music,” I also added a playful moment where I cast a
                spell on a dress form, transforming it as if my handmade
                clothing came to life. This sequence allowed me to integrate my
                background in fashion design into the MV in both a literal and
                surreal way. Because the green screen setup muted the colors of
                my rainbow outfit in other scenes, this became the place where I
                could highlight it more directly.
              </p>
              <div className="gif-wrapper small">
                <img src={production5} alt="production scene" loading="lazy" />
              </div>
          ...
          <DetailBox title="CHALLENGES & SOLUTIONS" colorClass="orange">
            <p>
              One of the biggest challenges came from using the Rotobrush tool.
              It made my computer extremely slow, especially since I shot some
              footage on my phone where the frame rate couldn’t be controlled.
              This meant I had to constantly adjust the composition’s frame rate
              whenever applying the Rotobrush.
            </p>
            <br />
            ...
            <p>
              ...
              issue. This way, I no longer had to change frame rate settings for
              every composition.
            </p>
            <br />

            <p>
              Another challenge was managing the large file size caused by using
              many nested compositions. To avoid slowing down my computer, I
              realized I could have split the project into a “first half” and
              “second half,” then combined them at the end. This workflow would
              have kept the files lighter and more efficient.
            </p>
          </DetailBox>
        </div>
