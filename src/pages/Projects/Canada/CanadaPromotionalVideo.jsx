        ...
        <div className="detail-box-wrapper">
          ...
          <FadeInOnScroll>
            <DetailBox title="Overview" colorClass="pink">
              <p>
                ...
                Our group selected a travel agency, and the goal was to produce
                a 2–5 minute piece based on the storyboard we developed in the
                previous term.
              </p>
            </DetailBox>
          </FadeInOnScroll>
          ...
          <FadeInOnScroll>
            <DetailBox title="CONCEPT & DIRECTION" colorClass="green">
              <p>
                ...
                who feels lonely after arriving in Canada but eventually finds
                joy through online friendships during the pandemic. <br />{' '}
                <br />
                ...
                team wasn’t very enthusiastic either, so I proposed something
                more fun to create, something that would reflect our real
                experiences.
              </p>
            </DetailBox>
          </FadeInOnScroll>
          ...
          <FadeInOnScroll>
            <DetailBox title="MUSIC & EDITING" colorClass="orange">
              <p>
                I wrote the lyrics in Japanese and generated the song using the
                AI music tool Suno. Since AI outcomes vary each time, I
                generated several tracks and chose the one with the most catchy,
                upbeat, and memorable melody. I also structured the video to
                include dramatic cutscenes between musical sections, making it
                more engaging and not just a simple music video.
              </p>
          ...
          <FadeInOnScroll>
            <DetailBox title="PRODUCTION HIGHLIGHTS" colorClass="pink">
              <p>
                The video features a mix of scripted acting, vlog-style
                dialogue, original music, and comedic exaggeration. We wanted it
